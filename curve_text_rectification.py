...
if __name__ == '__main__':
    ...
    test_points = [106, 167, 147, 143, 264, 94, 319, 85, 443, 98, 492, 116, 557,
                     148, 539, 181, 474, 149, 435, 135, 319, 122, 274, 130, 166, 176,
                     125, 200]

    image_path = './data/test_images/arc_text.jpg'
    ...
    cv2.imwrite(os.path.join(save_path, 'OneBoxImageResult.jpg'), res)
    print('{} is saved.'.format(os.path.join(save_path, 'OneBoxImageResult.jpg')))
    print('done!')